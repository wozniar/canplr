theme_canpl <- function(base_size = 25) {
  theme(
    ...
    panel.grid.major = element_line(colour = alpha(league_colours[3], 0.5), linetype = "dashed"),
    ...
    plot.subtitle = element_text(color = league_colours[2], hjust = 0.5, lineheight = 0.3, margin = unit(c(0, 0, 15, 0), "pt"), size = 35),
